...
public class SamusShipBoss extends GameObjects {
	...
	private Array<GameObjects> listOfEnemies;
	...
	public SamusShipBoss(float x, float y, float dx, float dy, PlayState playState, AssetManager assetManager) {
	...
	private void init() {
		...
		// Arrays
		enemyBullets = playState.getEnemyBulletList();
		explosionList = playState.getExplosionList();
		listOfEnemies = playState.getAllEnemies();
